...
3. **How are we related?**: relationship naming (up to "second cousin twice removed", step relatives, partners, in-laws), shortest path, "relation to you" labels throughout
4. **Interactive tree and quick view**: automatic layout, couple / parent / step line styles, drag and zoom, tap to inspect, add relatives from the tree, show a path on the tree. Adds the Tree tab.
