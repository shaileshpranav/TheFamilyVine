...
from app.routers import conditions, events, graph, invites, me, people, photos, subtrees, trees
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    for module in (me, trees, invites, subtrees, people, events, graph, photos, conditions):
